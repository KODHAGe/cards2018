...
class Xmas extends Component {
  ...
  sketch = (sketch) => {
    ...
    sketch.draw = () => {
      pixelate(this.state.pixelSize, this.state.squarePixels, this.state.flicker)
  ...
  render() {
    ...
    if(this.state.image) {
      ...
      render = <input className="url" placeholder="Image URL" onChange={this.getImage}></input>
    }
    ...
    return (
      <div className="Xmas">
        ...
        <div className={controls}>
          ...
          <Slider defaultValue={this.state.pixelSize} id="pixelate-slider" onChange={this.updateValue} min={10} max={400} />
          <label>Square pixels</label>
          <input type="checkbox" name="square" checked={this.state.squarePixels} onChange={this.handleSquareChange}></input>
          <label>Flicker</label>
          <input type="checkbox" name="square" checked={this.state.flicker} onChange={this.handleFlickerChange}></input>
        </div>
      </div>
    );
  }
